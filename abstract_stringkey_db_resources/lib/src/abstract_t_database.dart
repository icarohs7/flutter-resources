...
import 'package:abstract_stringkey_db_resources/src/abstract_json_database.dart';
...
class AbstractTDatabase<T> {
  ...
  ///Store single item
  Future<String> insert(T item, {String? key}) {
  ...
  Future<void> replaceAllWithKeys(Map<String, T> items) {
  ...
  Stream<T?> streamSingle(String key) {
    return jsonDatabase
        .streamSingle(key)

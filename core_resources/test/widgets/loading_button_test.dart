...
void main() {
  testWidgets('LoadingRaisedButton', (WidgetTester tester) async {
  ...
  testWidgets('LoadingFlatButton', (WidgetTester tester) async {
    final isLoading = ValueNotifier(false);
    var count = 0;
    ...
    isLoading.value = false;
    await tester.pump(Duration(milliseconds: 300));
    await tester.tap(find.byType(LoadingFlatButton));
    expect(count, 1);
  });
